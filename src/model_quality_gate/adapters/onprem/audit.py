...
discarding the event: an unimplemented audit sink must never silently drop a gate /
eval / red-team record, so porting on-premise *must* supply a real immutable (WORM) audit
