...
class LlmRequest:
    ...
    #: 0.0 where the output is extracted, classified, scored or compared; leave drafting and
    #: narration free. Free means ABSENT, never 1.0: some models reject the parameter.
