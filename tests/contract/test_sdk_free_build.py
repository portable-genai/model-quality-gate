...
at all, and CONTRIBUTING.md lists it as a hard rule ("Keep GCP imports lazy").

Nothing enforced it. The parity and portability suites construct only the SDK-free profiles, so
they never import the managed adapter modules, and a ``from google.cloud import aiplatform`` hoisted
